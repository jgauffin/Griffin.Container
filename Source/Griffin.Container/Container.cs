...
namespace Griffin.Container
{
    ...
    public class Container : ContainerBase, IParentContainer
    {
        ...
        public Container(Dictionary<Type, List<BuildPlan>> serviceMappings) : base(serviceMappings)
        {
        ...
        public Container(Dictionary<Type, List<BuildPlan>> serviceMappings, IInstanceStorageFactory factory) : base(serviceMappings)
        {
            if (serviceMappings == null) throw new ArgumentNullException("serviceMappings");
            _factory = factory;
        ...
        {
            return bp.GetInstance(_storage, null);
        }
    }
}
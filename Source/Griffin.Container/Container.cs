...
namespace Griffin.Container
{
    ...
    public class Container : ContainerBase, IParentContainer
    {
        ...
        public Container(IDictionary<Type, List<IBuildPlan>> serviceMappings) : base(serviceMappings)
        {
        ...
        public Container(Dictionary<Type, List<IBuildPlan>> serviceMappings, IInstanceStorageFactory factory)
